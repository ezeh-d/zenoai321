...
//
// STATES/SPECIALIST_IDS and the whole dimensional Emotion Engine now live in
// character_brain.js, shared with character.js (the 2D cartoon companion)
// so the two renderers never carry two copies of the same "brain" -- this
// is a pure import swap, the values and derivation logic are unchanged.
import {
  STATES, SPECIALIST_IDS, EMOTION_PROTECTED_STATES as _EMOTION_PROTECTED_STATES,
  createEmotionEngine as _createEmotionEngine,
} from "./character_brain.js";
