...
TOOL_CAPABILITY: dict[str, str] = {
    ...
    "career_profile_update": "filesystem_write",
    "career_profile_fill_field": "browser_automation",
    "paid_work_scout": "filesystem_write",
    "paid_work_ingest_opportunity": "filesystem_write",
    "paid_work_profile_variant": "filesystem_write",
    "paid_work_portfolio_add": "filesystem_write",
    "paid_work_prepare_application": "filesystem_write",
    "paid_work_record_submission": "filesystem_write",
    "paid_work_client_review": "filesystem_write",
    "paid_work_client_message": "filesystem_write",
    "paid_work_set_pricing": "filesystem_write",
    "paid_work_negotiate": "filesystem_write",
    "paid_work_contract": "filesystem_write",
    "paid_work_project": "filesystem_write",
    "paid_work_record_delivery": "filesystem_write",
    "paid_work_payment": "filesystem_write",
    "paid_work_owner_decision": "filesystem_write",
    "paid_work_social_event": "filesystem_write",
    "paid_work_dry_run": "filesystem_write",
    "paid_work_focus": "filesystem_write",
    ...
    "send_to_chat": "messaging_send",
    "type_message": "desktop_automation",
